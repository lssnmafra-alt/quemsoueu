...
function characterKey(name: string) {
  ...
  if (normalized.includes('HULK') && normalized.includes('MARVEL')) return 'HULK_MARVEL';
...
export default function DeckEditorPage() {
  ...
  useEffect(() => {
    ...
    const fetchDeck = async () => {
      ...
      setDeck({ id: deckId, is_public: false, cover_url: '', ...dData, creator_nickname: creatorNickname, name: dData?.name || 'Personagens Oficiais do Jogo' });
