...
export default function OfficialName({ name, theme, showLabel = false }: OfficialNameProps) {
  return (
    <div className="pointer-events-none absolute inset-x-1.5 bottom-2 z-30 flex min-h-[2rem] items-end justify-center px-1.5 pb-1.5 text-center">
      <div className="min-w-0 max-w-full">
        ...
        <p
          className={cn(
            'font-display text-balance hyphens-none whitespace-normal text-[clamp(0.54rem,2.35vw,0.84rem)] font-black uppercase leading-[1.02] tracking-[0.045em] drop-shadow-[0_2px_2px_rgba(0,0,0,0.95)]',
