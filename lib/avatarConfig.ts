...
export const AVATAR_OPTIONS = {
  ...
  clothes: [
    ...
    { id: 'clothes-02', label: 'Camisa esportiva lisa' },
    { id: 'clothes-03', label: 'Armadura pesada' },
    { id: 'clothes-04', label: 'Manto liso' },
    { id: 'clothes-05', label: 'Jaqueta street' },
    { id: 'clothes-06', label: 'Traje espacial' },
    { id: 'clothes-07', label: 'Macacao justo' },
    ...
    { id: 'clothes-13', label: 'Body heroico liso' },
    { id: 'clothes-14', label: 'Roupa palco lisa' },
    { id: 'clothes-15', label: 'Vestido bruxa liso' },
    { id: 'clothes-16', label: 'Traje realeza liso' },
    { id: 'clothes-17', label: 'Armadura tech lisa' },
    { id: 'clothes-18', label: 'Moletom liso' },
    { id: 'clothes-19', label: 'Detetive blazer' },
    { id: 'clothes-20', label: 'Casaco nobre liso' },
    { id: 'clothes-21', label: 'Farda futurista lisa' },
    { id: 'clothes-22', label: 'Body feminino liso' },
    { id: 'clothes-23', label: 'Luxo branco' },
    { id: 'clothes-24', label: 'Vestido bruxa' },
    { id: 'clothes-25', label: 'Roupa pop lisa' },
    { id: 'clothes-26', label: 'Uniforme magico liso' },
...
const KIND_OPTION_RULES: Record<AvatarKind, Partial<Record<AvatarCategory, readonly string[]>>> = {
  male: {
    ...
    clothesDetail: ['detail-none', 'detail-number', 'detail-lightning', 'detail-star', 'detail-gem', 'detail-x', 'detail-stripes', 'detail-diagonal', 'detail-circle', 'detail-crown', 'detail-neon'],
  ...
  female: {
    ...
    clothesDetail: ['detail-none', 'detail-star', 'detail-gem', 'detail-x', 'detail-stripes', 'detail-diagonal', 'detail-circle', 'detail-heart', 'detail-crown', 'detail-wings', 'detail-neon', 'detail-magic'],
  ...
  creature: {
    ...
    clothesDetail: ['detail-none', 'detail-lightning', 'detail-gem', 'detail-x', 'detail-stripes', 'detail-circle', 'detail-neon', 'detail-magic'],
...
export function randomAvatarConfig(kind?: AvatarKind): AvatarConfig {
  ...
  const humanBase = (patch: Partial<AvatarConfig> = {}): Partial<AvatarConfig> => {
    ...
    return {
      ...
      clothesDetail: randomFrom(['detail-none', 'detail-none', 'detail-stripes', 'detail-diagonal', 'detail-circle']),
