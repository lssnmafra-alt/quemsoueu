...
export const AVATAR_OPTIONS = {
  ...
  face: [
    ...
    { id: 'face-05', label: 'Robusto' },
    { id: 'face-07', label: 'Angular' },
    { id: 'face-09', label: 'Sintetico' },
    { id: 'face-10', label: 'Aquatico' },
  ],
  eyebrows: [
  ...
  clothes: [
    { id: 'clothes-01', label: 'Camiseta lisa' },
    { id: 'clothes-31', label: 'Regata' },
    { id: 'clothes-18', label: 'Moletom' },
    { id: 'clothes-05', label: 'Jaqueta aberta' },
    { id: 'clothes-32', label: 'Jaqueta fechada' },
    { id: 'clothes-13', label: 'Body justo' },
    { id: 'clothes-33', label: 'Armadura leve' },
    { id: 'clothes-03', label: 'Armadura pesada' },
    { id: 'clothes-04', label: 'Manto' },
    { id: 'clothes-19', label: 'Terno / blazer' },
    { id: 'clothes-02', label: 'Uniforme esportivo' },
    { id: 'clothes-12', label: 'Ninja' },
    { id: 'clothes-07', label: 'Macacao' },
    { id: 'clothes-10', label: 'Pele monstro' },
  ],
  clothesDetail: [
    { id: 'detail-none', label: 'Sem detalhe' },
    { id: 'detail-text', label: 'Numero / letra editavel' },
    { id: 'detail-number', label: 'Numero fixo 10' },
    { id: 'detail-lightning', label: 'Raio' },
    { id: 'detail-star', label: 'Estrela' },
    { id: 'detail-gem', label: 'Gema no peito' },
    { id: 'detail-x', label: 'X no peito' },
    { id: 'detail-stripes', label: 'Listras' },
    { id: 'detail-diagonal', label: 'Faixa diagonal' },
    { id: 'detail-circle', label: 'Simbolo circular' },
    { id: 'detail-heart', label: 'Coracao' },
    { id: 'detail-crown', label: 'Coroa' },
    { id: 'detail-wings', label: 'Asas' },
    { id: 'detail-neon', label: 'Linha neon' },
    { id: 'detail-magic', label: 'Emblema magico' },
  ],
  sleeves: [
  ...
  accessory: [
    ...
    { id: 'accessory-eye-glasses', label: 'Oculos finos' },
    { id: 'accessory-eye-visor', label: 'Visor neon' },
    { id: 'accessory-eye-patch', label: 'Tapa-olho' },
...
const KIND_OPTION_RULES: Record<AvatarKind, Partial<Record<AvatarCategory, readonly string[]>>> = {
  male: {
    skin: ['skin-01', 'skin-02', 'skin-03', 'skin-04', 'skin-05'],
    face: ['face-01', 'face-03', 'face-04', 'face-05', 'face-07'],
    eyebrows: ['brows-01', 'brows-02', 'brows-03', 'brows-04', 'brows-05', 'brows-06'],
    eyes: ['eyes-01', 'eyes-02', 'eyes-03', 'eyes-04', 'eyes-05'],
    nose: ['nose-01', 'nose-03', 'nose-04', 'nose-05'],
    ...
    clothes: ['clothes-01', 'clothes-31', 'clothes-18', 'clothes-05', 'clothes-32', 'clothes-13', 'clothes-33', 'clothes-03', 'clothes-04', 'clothes-19', 'clothes-02', 'clothes-12', 'clothes-07'],
    clothesDetail: ['detail-none', 'detail-text', 'detail-number', 'detail-lightning', 'detail-star', 'detail-gem', 'detail-x', 'detail-stripes', 'detail-diagonal', 'detail-circle', 'detail-crown', 'detail-neon'],
    outerwear: ['outerwear-none', 'outerwear-cape', 'outerwear-armor', 'outerwear-jacket'],
    accessory: ['none', 'accessory-eye-glasses', 'accessory-eye-visor', 'accessory-eye-patch', 'accessory-01', 'accessory-02', 'accessory-03', 'accessory-04', 'accessory-05', 'accessory-09', 'accessory-10', 'accessory-13', 'accessory-14', 'accessory-15', 'accessory-16'],
  },
  female: {
    skin: ['skin-01', 'skin-02', 'skin-03', 'skin-04', 'skin-05', 'skin-08'],
    face: ['face-01', 'face-03', 'face-04', 'face-05', 'face-07'],
    eyebrows: ['brows-01', 'brows-02', 'brows-03', 'brows-04', 'brows-05'],
    eyes: ['eyes-01', 'eyes-02', 'eyes-04', 'eyes-05', 'eyes-11'],
    ...
    clothes: ['clothes-01', 'clothes-31', 'clothes-18', 'clothes-05', 'clothes-32', 'clothes-13', 'clothes-33', 'clothes-03', 'clothes-04', 'clothes-19', 'clothes-02', 'clothes-12', 'clothes-07'],
    clothesDetail: ['detail-none', 'detail-text', 'detail-star', 'detail-gem', 'detail-x', 'detail-stripes', 'detail-diagonal', 'detail-circle', 'detail-heart', 'detail-crown', 'detail-wings', 'detail-neon', 'detail-magic'],
    outerwear: ['outerwear-none', 'outerwear-cape', 'outerwear-robe', 'outerwear-ruff', 'outerwear-jacket'],
    accessory: ['none', 'accessory-eye-glasses', 'accessory-eye-visor', 'accessory-eye-patch', 'accessory-01', 'accessory-03', 'accessory-04', 'accessory-05', 'accessory-07', 'accessory-10', 'accessory-11', 'accessory-14', 'accessory-15', 'accessory-16'],
  },
  creature: {
    skin: ['skin-06', 'skin-07', 'skin-08', 'skin-09'],
    face: ['face-05', 'face-09', 'face-10'],
    eyebrows: ['brows-03', 'brows-04', 'brows-06'],
    eyes: ['eyes-03', 'eyes-06', 'eyes-07', 'eyes-08', 'eyes-11', 'eyes-12'],
    ...
    clothes: ['clothes-10', 'clothes-03', 'clothes-33', 'clothes-04', 'clothes-07', 'clothes-12'],
    clothesDetail: ['detail-none', 'detail-text', 'detail-lightning', 'detail-gem', 'detail-x', 'detail-stripes', 'detail-circle', 'detail-neon', 'detail-magic'],
    outerwear: ['outerwear-none', 'outerwear-cape', 'outerwear-robe', 'outerwear-armor'],
    accessory: ['none', 'accessory-eye-visor', 'accessory-eye-patch', 'accessory-02', 'accessory-04', 'accessory-06', 'accessory-07', 'accessory-08', 'accessory-11', 'accessory-12', 'accessory-13'],
  },
};
...
export function switchAvatarKind(config: AvatarConfig, kind: AvatarKind): AvatarConfig {
  ...
  return normalizeAvatarConfig({
    ...
    clothesDetail: defaults.clothesDetail,
    clothesText: defaults.clothesText,
    sleeves: defaults.sleeves,
    arms: defaults.arms,
    clothesColor: defaults.clothesColor,
    detailColor: defaults.detailColor,
    accessoryColor: defaults.accessoryColor,
...
export function normalizeAvatarConfig(value: unknown): AvatarConfig {
  ...
  return applyKindRules({
    ...
    clothesDetail: pickOption('clothesDetail', draft.clothesDetail),
    clothesText: normalizeClothesText(draft.clothesText),
    ...
    accessoryColor: isHexColor(draft.accessoryColor) ? draft.accessoryColor! : DEFAULT_AVATAR_CONFIG.accessoryColor,
...
export function randomAvatarConfig(kind?: AvatarKind): AvatarConfig {
  ...
  const humanFaces = ['face-01', 'face-03', 'face-05', 'face-07', 'face-01'];
  ...
  const humanBase = (patch: Partial<AvatarConfig> = {}): Partial<AvatarConfig> => {
    ...
    return {
      ...
      clothesDetail: randomFrom(['detail-none', 'detail-none', 'detail-text', 'detail-stripes', 'detail-diagonal', 'detail-circle']),
      clothesText: randomFrom(['10', '7', 'A', 'S', 'BR']),
      ...
      accessoryColor: randomFrom(['#38bdf8', '#facc15', '#f8fafc', '#a78bfa']),
      ...patch,
    };
  };
  ...
  const archetypes: Array<{ weight: number; build: () => Partial<AvatarConfig> }> = [
    {
      ...
      build: () => humanBase({
        ...
        clothes: randomFrom(['clothes-01', 'clothes-05', 'clothes-18', 'clothes-05', 'clothes-19', 'clothes-05', 'clothes-19']),
    ...
    },
    {
      ...
      build: () => humanBase({
        ...
        clothes: randomFrom(['clothes-02', 'clothes-07', 'clothes-31']),
    ...
    },
    {
      ...
      build: () => humanBase({
        ...
        eyes: randomFrom(['eyes-01', 'eyes-02', 'eyes-04', 'eyes-02']),
        hair: randomFrom(['hair-01', 'hair-03', 'hair-13', 'hair-15', 'hair-18']),
        body: randomFrom(['body-01', 'body-02']),
        clothes: randomFrom(['clothes-05', 'clothes-19', 'clothes-01', 'clothes-19', 'clothes-19']),
    ...
    },
    {
      ...
      build: () => normalizePreset({
        ...
        hairColor: '#111827',
        body: 'body-02',
        clothes: randomFrom(['clothes-07', 'clothes-03', 'clothes-03']),
        clothesColor: randomFrom(['#334155', '#475569', '#0f766e', '#2563eb']),
        detailColor: '#facc15',
        outerwear: 'outerwear-armor',
        accessory: randomFrom(['none', 'accessory-eye-visor']),
        marking: 'marking-cyber',
        aura: 'aura-tech',
    ...
    },
    {
      ...
      build: () => normalizePreset({
        ...
        clothes: randomFrom(['clothes-04', 'clothes-04', 'clothes-04', 'clothes-13', 'clothes-13', 'clothes-04', 'clothes-05', 'clothes-04']),
    ...
    },
    {
      ...
      build: () => normalizePreset({
        ...
        hairColor: '#064e3b',
        body: 'body-03',
        clothes: randomFrom(['clothes-10', 'clothes-31']),
    ...
    },
    {
      ...
      build: () => normalizePreset({
        ...
        hairColor: '#94a3b8',
        body: 'body-05',
        clothes: randomFrom(['clothes-03', 'clothes-03']),
...
function normalizePreset(config: AvatarConfig): AvatarConfig {
  return normalizeAvatarConfig({
    ...
    accessoryColor: isHexColor(config.accessoryColor) ? config.accessoryColor : DEFAULT_AVATAR_CONFIG.accessoryColor,
    clothesText: normalizeClothesText(config.clothesText),
  });
}
...
function randomKindAvatar(kind: AvatarKind): AvatarConfig {
  ...
  return normalizeAvatarConfig({
    ...
    clothesDetail: randomFrom(getAvatarOptionsForKind('clothesDetail', kind).map((option) => option.id)),
    clothesText: randomFrom(['10', '7', 'A', 'S', 'XP', 'BR']),
    ...
    detailColor: randomFrom(detailColors),
    accessoryColor: randomFrom(detailColors),
    outerwear: randomFrom(getAvatarOptionsForKind('outerwear', kind).map((option) => option.id)),
    accessory: kind === 'female'
      ? randomFrom(['none', 'none', 'accessory-eye-glasses', 'accessory-05', 'accessory-10', 'accessory-11', 'accessory-15'])
      : randomFrom(['none', 'none', 'none', 'accessory-eye-visor', 'accessory-06', 'accessory-07', 'accessory-08']),
    marking: kind === 'female'
      ? randomFrom(['marking-none', 'marking-freckles', 'marking-arcane', 'marking-royal'])
      : randomFrom(['marking-none', 'marking-none', 'marking-warpaint', 'marking-cyber', 'marking-arcane']),
    aura: kind === 'female'
...
function normalizeClothesText(value?: string) {
  const cleaned = String(value || DEFAULT_AVATAR_CONFIG.clothesText)
    .replace(/[^0-9A-Za-zÀ-ÿ]/g, '')
    .toUpperCase()
    .slice(0, 2);

  return cleaned || DEFAULT_AVATAR_CONFIG.clothesText;
}
