export const PUBLIC_ENV_KEYS = [
  ...
  'NEXT_PUBLIC_HOME_AVATAR_VIDEO_URL',
] as const;
...
export const PUBLIC_ENV_ALIASES: Record<PublicEnvKey, string[]> = {
  ...
  NEXT_PUBLIC_SUPABASE_URL_GAME: ['SUPABASE_URL_GAME'],
  NEXT_PUBLIC_SUPABASE_ANON_KEY_GAME: ['SUPABASE_ANON_KEY_GAME'],
  NEXT_PUBLIC_HOME_AVATAR_VIDEO_URL: ['HOME_AVATAR_VIDEO_URL'],
};
